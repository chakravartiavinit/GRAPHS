...
int main()
{
    ...
    int n, m;
    cin >> n >> m;
    string hor_ver, left_right;
    cin >> left_right >> hor_ver;
    if (left_right[0] == '<' && left_right[n - 1] == '>' && hor_ver[0] == 'v' && hor_ver[m - 1] == '^')
    {
        cout << "YES\n";
    }
    else if (left_right[0] == '>' && left_right[n - 1] == '<' && hor_ver[0] == '^' && hor_ver[m - 1] == 'v')
    {
        cout << "YES\n";
    }
    else

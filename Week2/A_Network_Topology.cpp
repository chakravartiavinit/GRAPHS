...
/*###############################################################################################################################################*/
void dfs(int start, vector<bool> &visited, map<int, vector<int>> &graph)
{
    visited[start] = true;
...
int main()
{
    ...
    for (int i = 1; i <= n; ++i)
    {
        ...
        else if ((indegree[i] + outdegree[i]) == 2)
        {
            two++;
        }
    }
    ...
    else
    {
        ...
        {
            int other_node = 0, special_node = 0;
            for (int i = 1; i <= n; ++i)
            {
                if ((indegree[i] + outdegree[i]) == 1)
                {
                ...
                else if ((indegree[i] + outdegree[i]) == (n - 1))
                {
                    special_node++;
                }
            }
            if (special_node == 1 && other_node == (n - 1))
            {
                cout << "star topology\n";
            }
            else
